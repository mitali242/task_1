...
//import mypcakage.UserRegistration;
...
public class MainPage extends Application {
  ...
  public void start(Stage primaryStage) {
      ...
      stackPane.getChildren().add(aboutUsPage);
      ...
      // Add more content to the main page
      // ...
      ...
      /*AboutUsPage aboutUsPage = new AboutUsPage();
      Scene scene = new Scene(aboutUsPage, 800, 600);
      primaryStage.setScene(scene);
      primaryStage.show();*/
