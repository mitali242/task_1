...
public class UserRegistration extends JFrame {
    ...
    public UserRegistration() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                msg += " \n";
                if (!validateForm(userName, len, emailId, password)) {
                	JOptionPane.showMessageDialog(btnNewButton,"Invalid form data. Please try again.");
                    return;
                }
                try {
                    Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/task_1", "root", "");
    ...
    private static boolean validateForm(String userName, int len, String emailId, String password) {
        // Perform your form validation logic here
        // Return true if the form data is valid, false otherwise
        return !userName.isEmpty() && len == 10 && isValidEmail(emailId) && !password.isEmpty();
    }
